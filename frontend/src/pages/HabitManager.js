      ...
      <header className="border-b border-white/5 bg-background-paper/50 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="font-heading text-2xl font-bold text-white flex items-center gap-2" data-testid="habit-manager-title">
                  ...
                  {PRESET_COLORS.map((color) => (
                    <motion.button
                      ...
                      className={`
                        ...
                        ${newHabit.color === color.value ? 'ring-2 ring-primary ring-offset-2 ring-offset-background shadow-glow' : 'hover:scale-110'}
                      `}
                      style={{ 
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="font-body font-bold text-xl text-white mb-1">
                      {habit.name}
                    </h4>
